...
if (Config.WORKTYPE == 'private') {
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: 'Made by 𝑩𝑨𝑩𝒀-𝑩𝑶𝑻🧚‍♂️'})
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: '𝑩𝑨𝑩𝒀-𝑩𝑶𝑻🧚‍♂️'})
